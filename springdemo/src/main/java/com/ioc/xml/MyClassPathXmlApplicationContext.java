...
public class MyClassPathXmlApplicationContext {
    ...
    public MyClassPathXmlApplicationContext(String configLocation) throws DocumentException, ClassNotFoundException, IllegalAccessException, NoSuchFieldException, InstantiationException {
      InputStream resource= MyClassPathXmlApplicationContext.class.getClassLoader().getResourceAsStream(configLocation);
        /*通过dom4j读取xml文件*/
